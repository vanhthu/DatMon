<%@ Page Title="Về FoodBook" Language="C#" MasterPageFile="~/User/User.Master" AutoEventWireup="true" CodeBehind="About.aspx.cs" Inherits="DACN.User.About" %>
    ...
    <section class="about_section layout_padding">
        <div class="container  ">
            ...
            <div class="row">
                <div class="col-md-6 ">
                    <div class="img-box">
                        <img src="../UserStyle/images/about-img.png" alt="">
                    </div>
                </div>
                <div class="col-md-6">
                ...
                Đà Lạt,…. Chúng tôi đang dần mở rộng thêm nhiều khu vực trong thời gian tới!
                        ...
                        <p>
                            Feane giao hàng nhanh thần tốc, đảm bảo mang cho bạn bữa ăn nóng hổi và ngon lành,
                  dù bạn đang ở đâu.
                        </p>
